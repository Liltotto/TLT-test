...
const MySelector = ({ options, selectedOption, onOptionSelect }: Props) => {
  ...
  return (
    <div ref={selectRef} className="relative inline-block">
      <div
        className={`flex justify-between items-center appearance-none w-full bg-[#D6DAE0] text-[#888F99] px-[10px] py-[6px] rounded shadow leading-tight focus:outline-none focus:shadow-outline ${
