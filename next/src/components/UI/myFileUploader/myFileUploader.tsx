        ...
        <div className="flex flex-col w-full gap-1">
            ...
            {file ? (
                <div className="relative flex justify-between">
                    <img src={URL.createObjectURL(file)} alt="Preview" className="w-[56px] h-[56px] object-contain rounded-md" />

                    <div className='flex items-center gap-2.5'>
                        <span className="block text-sm text-gray-600 max-w-[200px] overflow-hidden overflow-ellipsis">{file.name}</span>
                        <div className=" text-gray-600">
                            <button className="bg-transparent focus:outline-none" onClick={handleDeleteFile}>
                ...
                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-[298ps] h-[64px] rounded-lg cursor-pointer">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">Загрузить фото</p>
